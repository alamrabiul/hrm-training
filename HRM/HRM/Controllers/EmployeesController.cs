...
namespace HRM.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        {
            var employee = db.Employee.Include(e => e.Dept).Include(e => e.Designation);
        ...
        public ActionResult Create([Bind(Include = "Id,EmployeeCode,FullName,NickName,MobieNumber,Email,FatherName,MotherName,DesignationId,BloodGroup,DeptId,Address,EmployeePhotoPath,EmployeePhoto")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,EmployeeCode,FullName,NickName,MobieNumber,Email,FatherName,MotherName,DesignationId,BloodGroup,DeptId,Address,EmployeePhotoPath,EmployeePhoto")] Employee employee)
        {
            if (ModelState.IsValid)
            {
